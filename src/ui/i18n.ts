...
const TRANSLATIONS = {
  ru: {
    ...
    'title.tagline': 'tower defense на печатной плате',
    'title.start': 'НАЧАТЬ',
    'comic.click': 'кликните, чтобы продолжить…',
    'comic.1': 'Станция дальней связи «Вега-9». Десятилетиями антенны слушали пустоту — и однажды пустота ответила.',
    'comic.2': 'Сигнал оказался не посланием. Контрольные суммы сходились сами собой: код исполнялся прямо в приёмном тракте.',
    'comic.3': 'За ночь он расползся по платам станции, переписывая всё на своём пути. Заражённые цепи не отключить — питание ядра трогать нельзя.',
    'comic.4': 'Остался один инженер и ящик запасных чипов. Каждая плата — рубеж. Каждая дорожка — линия фронта.',
    'pause.title': 'ПАУЗА',
