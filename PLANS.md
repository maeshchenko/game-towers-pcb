...
- **Этап 2: финал** — задачи 1–11 juice-паса готовы (твины, частицы, shake, hit-stop, цифры
  урона, фильтры, живая плата, баннер/slam), переработка декора 2b готова (занятость, медь
  по правилам, приглушение, композиция). Осталось: перф-финал + полный QA-пасс (S02 Task 12) —
  FPS на 60×45 с боем, проверка тумблера «Сниженные эффекты», обновление доков.
